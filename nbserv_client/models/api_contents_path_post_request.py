...
class ApiContentsPathPostRequest(BaseModel):
    """
    ApiContentsPathPostRequest
    """ # noqa: E501
    copy_from: Optional[StrictStr] = None
    ext: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["copy_from", "ext", "type"]
